...
def check_permission_and_not_submitted(doc):
	...
	# check if submitted
	if doc.docstatus == 1:
		frappe.msgprint(_("{0} {1}: Submitted Record cannot be deleted. You must {2} Cancel {3} it first.").format(_(doc.doctype), doc.name, "<a href='https://help.onehash.ai/en/article/delete-submitted-document-12mk2bb/' target='_blank'>", "</a>"),
